...
/*
En una futura función para introducir productos en stock usaremos
"INSERT INTO "+ producto.getNombreTabla()+" VALUES "+producto.getInsertQuery();
 */
...
//NUEVA FUNCION
    ...
    public String getInsertQuery() {
        return "(default," +this.getColor()+"', "+this.getPrice()+")";
    }
